...
## Estamación
_El proceso de estimación en costos y tiempo, se realizo a traves de una plantilla donde se establece las horas laborales diarias, en conjunto con los sueldos de cada uno de los cargos del proyecto a desarrollar, y que por medio de una estimación por puntos de funciones obtenemos la cantidad de horas totales del proyecto con su costo final. **Mira el archivo** [estimaciones.xls] (estimaciones.xls) _
